...
// 1. Filter the list of inventors for those who were born in the 1500's
  ...
  //   }
  // });
//arrow function and true statement
...
//   }
// });
//with ternary                    if a is greater than b return 1 else return -1
...
//running total, and inventor
const totalYears = inventors.reduce((total, inventor) =>{
  //for each invidual inventor get total
  return total +(inventor.passed - inventor.year);
  //start with zero for the first pass
}, 0);
...
const transport = data.reduce(function(object, item){
  // console.log(item);
  //if there is no object item, set to zero, otherwise increment
  if(!object[item]){
    object[item] = 0
  }
  object[item]++;
